    ...
    public partial class Clientes : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if(!IsPostBack)
            {
                ...
                DatabaseUtility.DatabaseCrud("defaultconnection", "SELECT o.UserName as Cliente, sum(totalprod) as Compras FROM aspnetusers a" +
                    " inner join Orders o on a.UserName=o.Username inner join OrderDetails od on od.OrderId=o.OrderId group by o.username" +
                    " order by sum(totalprod) desc", Grid_top_clientes);
